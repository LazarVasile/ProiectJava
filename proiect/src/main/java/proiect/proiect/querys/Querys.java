...
public class Querys {
    ...
    public final static String ADD_EMPLOYEE ="INSERT INTO employee(id, cnp, firstName, lastName, phoneNumber," +
            "position, datefrom, salary) values (?,?,?,?,?,?,?,?)";
    ...
    public final static String ADD_CATEGORY ="INSERT INTO category(id, name) values (?,?)";
    ...
    public final static String ADD_PROVIDER ="INSERT INTO provider(id, name, address, phoneNumber) values (?,?,?,?)";
    ...
    public final static String ADD_SALES ="INSERT INTO sales(id, number, date, product) values (?,?,?,?)";
